...
import com.girsang.girsangkafe.UI.master.karyawan.JabatanDialog;
...
//</editor-fold>
    ...
    private void tampilData(){
        ...
        tabel.setModel(new TabelModelKategoriMenu(daftarKategoriMenu));
        ...
        txtCari.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent ke) {
                if ("".equals(txtCari.getText())) {
                    ...
                    daftarKategoriMenu = GirsangKafe.getMasterService()
                            .kategoriMenuBerdasaranNama(txtCari.getText());
                    tabel.setModel(new TabelModelKategoriMenu(daftarKategoriMenu));
                    tabel = new UkuranTabel().UkuranTabelKategoriMenu(tabel);
                }
            }
