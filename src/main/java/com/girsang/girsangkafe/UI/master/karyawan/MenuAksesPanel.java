...
//</editor-fold>
    ...
    private void addPopupmenu(){
        popup.add(new JMenuItem(new AbstractAction("Tambah Menu Akses") {
            @Override
            public void actionPerformed(ActionEvent ae) {
                baruJabatan();
            }
        }));
        popup.add(new JMenuItem(new AbstractAction("Edit Menu Akses") {
            @Override
            public void actionPerformed(ActionEvent ae) {
                editJabatan();
            }
        }));
        popup.add(new JMenuItem(new AbstractAction("Hapus Menu Akses") {
            @Override
            public void actionPerformed(ActionEvent ae) {
                hapusJabatan();
            }
